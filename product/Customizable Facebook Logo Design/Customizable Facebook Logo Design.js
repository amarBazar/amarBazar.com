      ...
      <section class="check-out-section">
          ...
          <div class="row billing-row">
              <div class="form-side">
                  ...
                  <label for="fb-page-name">fb page/profile name<sup>*</sup></label>
                  <input type="text" id="fb-page-name" name="Fb page name" required>
                  <label for="fb-page-link">fb page/profile link<sup>*</sup></label>
                  <input type="text" id="fb-page-link" name="Fb page link" required>
                  <div class="check-box">
                  ...
                  <div class="place-order">
                      ...
                      <div id="payment" popover="manual">
                          ...
                          <div class="full-payment">
                              ...
                              <p class="payment-condition advance-pay">To make a payment, send <span class="payment-out">৳ 200.00</span> taka via bKash and fill in the required details.</p>
